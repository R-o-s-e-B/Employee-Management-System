...
const tabConfig = [
  { id: "Dashboard", label: "Dashboard", icon: "M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6z M4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2z M14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6z M14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" },
...
const SideNavBar = ({ activeTab, onTabSelect }) => {
  return (
    <aside className="w-64 min-h-screen flex flex-col bg-slate-900 text-slate-200 shrink-0">
      <div className="p-5 border-b border-slate-700/50">
        <h1 className="text-lg font-semibold tracking-tight text-white">
          Org Manager
        </h1>
        <p className="text-xs text-slate-400 mt-0.5">Employee &amp; expenses</p>
      </div>
      ...
      <div className="p-3 border-t border-slate-700/50">
        <p className="text-xs text-slate-500 px-3">v1.0</p>
      </div>
    </aside>
  );
};
